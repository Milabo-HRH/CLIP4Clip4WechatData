...
def get_clip_loss(model, image_features, text_features, logit_scale, loss_img, loss_txt, accum_image_features=None, accum_text_features=None, accum_idx=-1, args=None):
    ...
    # print(text_features.t())
    # if(torch.isnan(image_features).any()):
    #     print("image_features has nan")
    #     exit(1)
    # if(torch.isnan(text_features).any()):
    #     print("text_features has nan")
    #     exit(1)
    ...
    ground_truth = ground_truth.cuda(args.__dict__['local_device_rank'], non_blocking=True)
